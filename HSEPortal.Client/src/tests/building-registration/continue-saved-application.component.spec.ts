...
import { ReturningApplicationComponent } from 'src/app/features/returning-application/returning-application.component';
import { ApplicationService } from 'src/app/services/application.service';
import { TestHelper, findComponent } from '../test-helper';
  ...
  testCasesShowError.forEach((test) => {
    new TestHelper()
      ...
      .setTestCase((applicationService: ApplicationService, value: any) => {
        applicationService.model.id = value;
        applicationService.model.ContactEmailAddress = 'validemailaddress@abcd.com';
        const enterdata = findComponent(fixture, ReturningApplicationEnterDataComponent);
        enterdata.properties['validateAndContinue']();
        expect(enterdata.properties['hasErrors']).toBeTrue();
