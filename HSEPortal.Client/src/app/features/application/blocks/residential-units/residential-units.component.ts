...
export class ResidentialUnitsComponent extends BaseComponent implements IHasNextPage {
  ...
  canContinue(): boolean {
    ...
    let residentialUnits = this.applicationService.currentBlock.ResidentialUnits;
  ...
  navigateToNextPage(navigationService: NavigationService, activatedRoute: ActivatedRoute): Promise<boolean> {
    return navigationService.navigateRelative('people-living-in-building', activatedRoute);
  }
}
