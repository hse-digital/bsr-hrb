...
export class OrganisationNameComponent extends BaseComponent implements IHasNextPage {
  ...
  constructor(router: Router, applicationService: ApplicationService, navigationService: NavigationService, activatedRoute: ActivatedRoute, private companiesService: CompaniesService, titleService: Title) {
