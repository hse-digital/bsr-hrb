...
export class MostRecentChangeComponent  extends BaseComponent implements IHasNextPage {
  ...
  override canAccess(routeSnapshot: ActivatedRouteSnapshot) {
    return !!this.applicationService.currenKbiSection!.UndergoneBuildingMaterialChanges
      && (this.applicationService.currenKbiSection!.UndergoneBuildingMaterialChanges.length > 1 && !this.applicationService.currenKbiSection!.UndergoneBuildingMaterialChanges.includes('floors_added'))

      //TODO include logic for extra floor added 
      ;
    return true;
  }
