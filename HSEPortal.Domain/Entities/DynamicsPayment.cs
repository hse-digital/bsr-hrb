...
public record DynamicsPayment(string bsr_paymentid = null, double? bsr_amountpaid = null, string bsr_lastfourdigitsofnumber = null, string bsr_timeanddateoftransaction = null, string bsr_transactionid = null,
