...
public record KbiSectionModel(string StrategyEvacuateBuilding, string[] ProvisionsEquipment, string[] FireSmokeProvisions, 
    ...
    Dictionary<string, string[]> FeatureMaterialsOutside, string PrimaryUseOfBuilding, string[] SecondaryUseBuilding, string FloorsBelowGroundLevel, string PrimaryUseBuildingBelowGroundLevel);
